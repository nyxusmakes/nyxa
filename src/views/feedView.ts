            ...
            folderCard.addEventListener('contextmenu', (event) => {
                ...
                menu.addItem((item) => {
                    item.setTitle('Delete Folder')
                        .setIcon('trash')
                        .onClick(async () => {
                            if (await showConfirm(this.app, `Are you sure you want to delete the folder "${folder.name}" and all its feeds?`)) {
                        ...
                        feedItem.addEventListener('contextmenu', (event) => {
                            ...
                            menu.addItem((item) => {
                                item.setTitle('Delete Feed')
                                    .setIcon('trash')
                                    .onClick(async () => {
                                        if (await showConfirm(this.app, `Are you sure you want to delete the feed "${feed.name}"?`)) {
